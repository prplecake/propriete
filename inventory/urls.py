...
urlpatterns = [
	...
	path('locations/<int:id>/', views.LocationDetail.as_view(), name='location_detail'),
	path('locations/<int:id>/delete/', views.LocationDelete.as_view(), name='location_delete'),

	path('clothing/', views.ClothingList.as_view(), name='clothing_list'),
	path('clothing/add/', views.ClothingAdd.as_view(), name='clothing_add'),
	path('clothing/<int:id>/edit/', views.ClothingUpdate.as_view(), name='clothing_update'),
	path('clothing/<int:id>/delete/', views.ClothingDelete.as_view(), name='clothing_delete'),
]
